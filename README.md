...
## ```USER REPLIT```
[![Run on Repl.it](https://repl.it/badge/github/Aril-MD/ElainaMultiDevice)](https://repl.it/github/Aril-MD/ElainaMultiDevice)
...
```bash
git clone https://github.com/Aril-MD/ElainaMultiDevice
